...
void Initialize(&SDL_Window windowname, ){
...
void LoadImage(const char** image, SDL_Texture texture, &SDL_Renderer render){
	SDL_Surface* surface
    surface = SDL_LoadBMP("./assets/brooke.bmp");
if (!surface) {
